    ...
    return (
        <div className='w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
            <a href='/'>
                ...
                <img className='p-8 rounded-t-lg' src='https://markmanson.net/wp-content/uploads/2023/06/books-by-mark-manson.png' alt='product_image1' />
            </a>
            <div className='px-5 pb-5'>
                <a href='/'>
                    <h5 className='text-xl font-semibold tracking-tight text-gray-900 dark:text-white'>
                        {/* Apple Watch Series 7 gps, Aluminium Case, Starlight Sports */}
                        Mark Manson Combo + Four Best Selling Books + Will + Models + Everything + The Subtle Art Of Not Giving A ***k (Paperback, Mark MAnson)
                    </h5>
                </a>
